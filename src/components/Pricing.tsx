...
export default function Pricing() {
  useEffect(() => {
    if (!document.querySelector('script[src="https://tinder.thrivecart.com/embed/v1/thrivecart.js"]')) {
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center">
          ...
          <a
            ...
            className="thrivecart-button thrivecart-button-styled thrivecart-button_style-rounded thrivecart-button-custom"
            style={{
              display: "inline-flex",
              alignItems: "center",
              justifyContent: "center",
              backgroundColor: "hsl(185, 60%, 22%)",
              color: "#ffffff",
